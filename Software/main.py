...
def mainn(way,chislo,chislo1):
    class MyWidget(QMainWindow, Ui_MainWindow):
        def __init__(self,*args, **kwargs):
            ...
            self.ui.label_7.setFont(QtGui.QFont('SansSerif', 16, QtGui.QFont.Weight.Bold))
            self.ui.label_7.setStyleSheet("font-weight: 900;")
            self.ui.label_2.setText(lab2)
            self.ui.label_2.setFont(QtGui.QFont('SansSerif', 16, QtGui.QFont.Weight.Bold))
            self.ui.label_2.setStyleSheet("font-weight: 900;")
            self.ui.label_3.setText(lab3)
            self.ui.label_3.setFont(QtGui.QFont('SansSerif', 16, QtGui.QFont.Weight.Bold))
            self.ui.label_3.setStyleSheet("font-weight: 900;")
            self.ui.label.setText(lab4)
            self.ui.label.setFont(QtGui.QFont('SansSerif', 16, QtGui.QFont.Weight.Bold))
            self.ui.label.setStyleSheet("font-weight: 900;")
            self.ui.label_10.setText(lab5)
            self.ui.label_10.setFont(QtGui.QFont('SansSerif', 16, QtGui.QFont.Weight.Bold))
            self.ui.label_10.setStyleSheet("font-weight: 900;")
            self.ui.label_9.setText(lab6)
            self.ui.label_9.setFont(QtGui.QFont('SansSerif', 16, QtGui.QFont.Weight.Bold))
            self.ui.label_9.setStyleSheet("font-weight: 900;")
            self.ui.label_11.setText(lab7)
            self.ui.label_11.setFont(QtGui.QFont('SansSerif', 16, QtGui.QFont.Weight.Bold))
            self.ui.label_11.setStyleSheet("font-weight: 900;")
            self.ui.label_12.setText(lab8)
            self.ui.label_12.setFont(QtGui.QFont('SansSerif', 16, QtGui.QFont.Weight.Bold))
            self.ui.label_12.setStyleSheet("font-weight: 900;")
            self.ui.label_8.setText(lab9)
            self.ui.label_8.setFont(QtGui.QFont('SansSerif', 16, QtGui.QFont.Weight.Bold))
            self.ui.label_8.setStyleSheet("font-weight: 900;")
